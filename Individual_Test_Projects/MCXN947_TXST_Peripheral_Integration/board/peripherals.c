...
static void ADC1_init(void) {
  /* Configuration of the component ADC1 of functional group BOARD_InitPeripherals is not valid. */
}
...
static void CTIMER0_init(void) {
  /* Configuration of the component CTIMER0 of functional group BOARD_InitPeripherals is not valid. */
}
...
static void LP_FLEXCOMM2_init(void) {
  /* Configuration of the component LP_FLEXCOMM2 of functional group BOARD_InitPeripherals is not valid. */
}
