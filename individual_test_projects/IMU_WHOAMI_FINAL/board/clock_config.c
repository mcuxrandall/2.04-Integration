...
- {id: SCG.PLL1M_MULT.scale, value: '268435456'}
- {id: SCG.PLL1SRCSEL.sel, value: SCG.FIRC_48M}
- {id: SCG.SCSSEL.sel, value: SCG.PLL0_CLK}
- {id: SYSCON.FLEXSPICLKSEL.sel, value: NO_CLOCK}
- {id: SYSCON.FREQMEREFCLKSEL.sel, value: SYSCON.evtg_out0a}
- {id: SYSCON.FREQMETARGETCLKSEL.sel, value: SYSCON.evtg_out0a}
- {id: SYSCON.I3C1FCLKDIV.scale, value: '96'}
- {id: SYSCON.I3C1FCLKSEL.sel, value: SYSCON.pll1_clk0}
...
void BOARD_BootClockPLL150M(void)
{
    ...
    const pll_setup_t pll1Setup = {
        ...
        .pllsscg = {(SCG_SPLLSSCG0_SS_MDIV_LSB(268435456U)),((SCG0->SPLLSSCG1 & ~SCG_SPLLSSCG1_SS_PD_MASK) | SCG_SPLLSSCG1_SS_MDIV_MSB(0U) | (uint32_t)(kSS_MF_512) | (uint32_t)(kSS_MR_K0) | (uint32_t)(kSS_MC_NOC) | SCG_SPLLSSCG1_SEL_SS_MDIV_MASK)},
        .pllRate = 192000000U
    };
    ...
    CLOCK_AttachClk(kPLL1_CLK0_to_I3C1FCLK);                 /*!< Switch I3C1FCLK to PLL1_CLK0 */
    CLOCK_AttachClk(kCLK_1M_to_WDT1);                 /*!< Switch WDT1 to CLK_1M */

    /*!< Set up dividers */
    CLOCK_SetClkDiv(kCLOCK_DivAhbClk, 1U);           /*!< Set AHBCLKDIV divider to value 1 */
    CLOCK_SetClkDiv(kCLOCK_DivI3c1FClk, 96U);           /*!< Set I3C1FCLKDIV divider to value 96 */
