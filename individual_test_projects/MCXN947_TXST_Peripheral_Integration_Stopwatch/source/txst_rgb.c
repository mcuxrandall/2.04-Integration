...
void output_RGB_val(uint32_t DutyCy_R, uint32_t DutyCy_G, uint32_t DutyCy_B) {
	...
	PWM_UpdatePwmDutycycle(RGBs_PWM_Type, kPWM_Module_1, kPWM_PwmA, kPWM_EdgeAligned, DutyCy_R);
	PWM_UpdatePwmDutycycle(RGBs_PWM_Type, kPWM_Module_1, kPWM_PwmB, kPWM_EdgeAligned, DutyCy_G);
	PWM_UpdatePwmDutycycle(RGBs_PWM_Type, kPWM_Module_2, kPWM_PwmA, kPWM_EdgeAligned, DutyCy_B);
